        ...
        <div class="form_content">
          ...
          <form method="post" action="{{url('checkstatus')}}" onsubmit="document.getElementById('zain_submit').disabled='true';" id="form_zain">
            ...
            <div class="form-group form-inline">
              ...
              <input type="tel" class="form-control" value="" id="phone" placeholder="أدخل رقم هاتفك الجوال" oninvalid="setCustomValidity('يجب ان تدخل 8 ارقام')" name="number" required pattern="[0-9]{8}">
              <span class="validity"></span>
            </div>

            <!--<button class="btn back">رجوع</button>-->
            <button id="zain_submit" class="btn" type="submit">الدخول</button>
          </form>
