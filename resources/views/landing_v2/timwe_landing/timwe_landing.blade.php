        ...
        <div class="form_content">
          ...
          <form method="post" action="{{url('subscription/optin/'.partnerRoleId)}}" onsubmit="document.getElementById('zain_submit').disabled='true';" id="form_zain">
            ...
            <div class="form-group form-inline">
              ...
              <input type="tel" class="form-control" value="" id="phone" placeholder="ادخل رقم تليفونك" oninvalid="setCustomValidity('يجب ان تدخل 8 ارقام')" name="number" required pattern="[0-9]{8}">
