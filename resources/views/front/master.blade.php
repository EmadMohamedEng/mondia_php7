      ...
      <div class="" style="z-index: 9999999999;">
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <ul class="navbar_ul navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-capitalize active_menu link_href" href="{{route('front.index')}}" style=" <?php echo $style ?> <?php echo $color ?>">
                <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 27 22"  xml:space="preserve" style="<?php echo $svg ?>">
