      ...
      <div class="" style="z-index: 9999999999;">
        ...
        <div id="mySidenav" class="sidenav">
          ...
          <ul class="navbar_ul navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link text-capitalize active_menu link_href" href="{{route('front.index')}}" style=" <?php echo $style ?>color:#efc049!important">
            ...
            <li class="nav-item">
              <a class="nav-link text-capitalize link_href" href="{{url('/mbc_portal_logout')}}" style=" <?php echo $style ?>">
                <i class="fa fa-key p-2 fa-2x" aria-hidden="true"></i>
                @lang('front.logout')
                <span class="sr-only">(current)</span>
              </a>
            </li>
