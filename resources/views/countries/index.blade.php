                        ...
                        @foreach($countries as $country)
                             <tr>
                                ...
                                <td class="visible-md visible-lg">
                                    <div class="btn-group">
                                    <a class="btn btn-sm btn-success show-tooltip" title="Add Operator" href="{{url("operators/create?country_id=".$country->id."&title=".$country->title)}}" data-original-title="Add Operator"><i class="fa fa-plus"></i></a>
