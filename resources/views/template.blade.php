...
if (Config::get('languages')[App::getLocale()] == "English") {
        ...
        <div class="container" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <!-- BEGIN Submenu -->
                <ul class="submenu">
                    <li id="countries-create"><a href="{{url('countries/create')}}">Add Country</a></li>
                    <li id="countries-index"><a href="{{url('countries')}}">List Countries</a></li>
                </ul>
                <!-- END Submenu -->
            </li>
                      <li id="operator">
                    ...
                    <ul class="nav nav-list">
                        <li id="providers">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="providers-index"><a href="{{url('providers')}}">List Providers</a></li>
                                <li id="providers-create"><a href="{{url('providers/create')}}">Create New Provider</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="services">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="services-index"><a href="{{url('services')}}">List Services</a></li>
                                <li id="services-create"><a href="{{url('services/create')}}">Create New Service</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="videos">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="videos-index"><a href="{{url('videos')}}">List Contents</a></li>
                                <li id="videos-create"><a href="{{url('videos/create')}}">Create New Item</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-list">
                        <li id="posts">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="posts-index"><a href="{{url('posts')}}">List Posts</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="audios">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="audios-index"><a href="{{url('audios')}}">List Rbts</a></li>
                                <li id="audios-index"><a href="{{url('listazan')}}">List Azan</a></li>
                                <li id="audios-create"><a href="{{url('audios/create')}}">Create New Item</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
