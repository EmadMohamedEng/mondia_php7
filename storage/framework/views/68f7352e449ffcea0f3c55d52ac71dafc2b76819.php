        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <form action="<?php echo e(url('setting/'.$setting->id.'/update')); ?>" method="post"
                        ...
                        <div class="form-group">
                            ...
                            $setting->type["title"] == "link" || $setting->type["title"] == "page"): ?>
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                                ...
                                <?php elseif($setting->type["title"] == "link"): ?>
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" name="link" value="<?php echo e($setting->value); ?>" class="form-control" required>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\islamic_services_php7\resources\views/setting/edit.blade.php ENDPATH**/ ?>