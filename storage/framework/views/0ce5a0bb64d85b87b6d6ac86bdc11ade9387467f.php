...
function ConfirmDelete()
{
    ...
    <body>
        ...
        <div id="navbar" class="navbar">
            ...
            <a class="navbar-brand" target="_blank" href="<?php echo e(url('/')); ?>">
                <small>
...
if (Config::get('languages')[App::getLocale()] == "English") {
                ...
                <li class="user-profile">
                    ...
                    <ul class="dropdown-menu dropdown-navbar" id="user_menu">
                        ...
                        <li>
                            <a href="<?php echo e(url('/logout_ad')); ?>">
                                <i class="fa fa-off"></i>
        ...
        <div class="container" id="main-container">
            ...
            <div id="sidebar" class="navbar-collapse collapse">
                ...
                <!-- BEGIN Submenu -->
                <ul class="submenu">
                    <li id="countries-create"><a href="<?php echo e(url('countries/create')); ?>">Add Country</a></li>
                    <li id="countries-index"><a href="<?php echo e(url('countries')); ?>">List Countries</a></li>
                </ul>
                <!-- END Submenu -->
            </li>
                      <li id="operator">
                        ...
                        <!-- BEGIN Submenu -->
                        <ul class="submenu">
                            <li id="operator-create"><a href="<?php echo e(url('operators/create')); ?>">Add Operators</a></li>
                            <li id="operator-index"><a href="<?php echo e(url('operators')); ?>">List Operators</a></li>
                        </ul>
                        <!-- END Submenu -->
                    </li>
                    ...
                    <ul class="nav nav-list">
                        <li id="providers">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="providers-index"><a href="<?php echo e(url('providers')); ?>">List Providers</a></li>
                                <li id="providers-create"><a href="<?php echo e(url('providers/create')); ?>">Create New Provider</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="services">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="services-index"><a href="<?php echo e(url('services')); ?>">List Services</a></li>
                                <li id="services-create"><a href="<?php echo e(url('services/create')); ?>">Create New Service</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="videos">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="videos-index"><a href="<?php echo e(url('videos')); ?>">List Contents</a></li>
                                <li id="videos-create"><a href="<?php echo e(url('videos/create')); ?>">Create New Item</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="posts">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="posts-index"><a href="<?php echo e(url('posts')); ?>">List Posts</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
                    <ul class="nav nav-list">
                        <li id="audios">
                            ...
                            <!-- BEGIN Submenu -->
                            <ul class="submenu">
                                <li id="audios-index"><a href="<?php echo e(url('audios')); ?>">List Rbts</a></li>
                                <li id="audios-index"><a href="<?php echo e(url('listazan')); ?>">List Azan</a></li>
                                <li id="audios-create"><a href="<?php echo e(url('audios/create')); ?>">Create New Item</a></li>
                            </ul>
                            <!-- END Submenu -->
                        </li>
                    </ul>
            ...
            <div class="footer" align="center" style=" position: absolute; width: 100%; bottom: 0;z-index: -9999">
...
<?php /**PATH C:\xampp\htdocs\islamic_services_php7\resources\views/template.blade.php ENDPATH**/ ?>