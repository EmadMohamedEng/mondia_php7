...
*/\n \n";
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(),[
            'method' => 'required|min:3|unique:routes,method,route',
            'route' => 'required|min:3|unique:routes,method,route',
    ...
    {
        $validator = Validator::make($request->all(),[
            'method' => 'required|unique:routes,method,'.$id.',id,route,'.$id,
            'route' => 'required|unique:routes,method,'.$id.',id,route,'.$id,
            'controller_name' => 'required' ,
            'function_name' => 'required'
        ]);
        if ($validator->fails()) {
